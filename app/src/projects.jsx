...
export default function projects() {
  return (
    <div className="w-full h-auto relative overflow-hidden flex items-center justify-center gap-8 flex-col mt-32">
      ...
      {/* Project 1 */}
      <div href="https://github.com/HenriqueBuen/analise-gastos-cartao" className="w-auto flex items-center justify-center border border-white/20 rounded-4xl gap-8 flex-col hover:scale-105 hover:border-cyan-300 border transition-transform cursor-pointer">
      ...
      {/* Project 2 */}
      <div href="https://github.com/HenriqueBuen/ParkVision" className="w-auto flex items-center justify-center border border-white/20 rounded-4xl gap-8 flex-col hover:scale-105 hover:border-cyan-300 border transition-transform cursor-pointer">
